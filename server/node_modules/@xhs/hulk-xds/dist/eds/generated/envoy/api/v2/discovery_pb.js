...
exports.Resource = exports.DeltaDiscoveryResponse = exports.DeltaDiscoveryRequest = exports.DiscoveryResponse = exports.DiscoveryRequest = void 0;
...
class DiscoveryRequest extends protobuf_1.Message {
    ...
    static typeName = "envoy.api.v2.DiscoveryRequest";
    static fields = protobuf_1.proto3.util.newFieldList(() => [
        { no: 1, name: "version_info", kind: "scalar", T: 9 /* ScalarType.STRING */ },
        { no: 2, name: "node", kind: "message", T: base_pb_1.Node },
        ...
        { no: 6, name: "error_detail", kind: "message", T: status_pb_1.Status },
    ]);
 ...
 */
class DiscoveryResponse extends protobuf_1.Message {
    /**
    ...
    static runtime = protobuf_1.proto3;
    static typeName = "envoy.api.v2.DiscoveryResponse";
    static fields = protobuf_1.proto3.util.newFieldList(() => [
        { no: 1, name: "version_info", kind: "scalar", T: 9 /* ScalarType.STRING */ },
        { no: 2, name: "resources", kind: "message", T: any_pb_1.Any, repeated: true },
        { no: 3, name: "canary", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
        { no: 4, name: "type_url", kind: "scalar", T: 9 /* ScalarType.STRING */ },
        { no: 5, name: "nonce", kind: "scalar", T: 9 /* ScalarType.STRING */ },
        { no: 6, name: "control_plane", kind: "message", T: base_pb_1.ControlPlane },
    ]);
    static fromBinary(bytes, options) {
    ...
    static equals(a, b) {
        return protobuf_1.proto3.util.equals(DiscoveryResponse, a, b);
    }
}
exports.DiscoveryResponse = DiscoveryResponse;
/**
 ...
 */
class DeltaDiscoveryRequest extends protobuf_1.Message {
    /**
     * The node making the request.
     *
    ...
    static runtime = protobuf_1.proto3;
    static typeName = "envoy.api.v2.DeltaDiscoveryRequest";
    static fields = protobuf_1.proto3.util.newFieldList(() => [
        { no: 1, name: "node", kind: "message", T: base_pb_1.Node },
        ...
        { no: 7, name: "error_detail", kind: "message", T: status_pb_1.Status },
    ]);
    static fromBinary(bytes, options) {
        return new DeltaDiscoveryRequest().fromBinary(bytes, options);
    }
    static fromJson(jsonValue, options) {
        return new DeltaDiscoveryRequest().fromJson(jsonValue, options);
    }
    static fromJsonString(jsonString, options) {
        return new DeltaDiscoveryRequest().fromJsonString(jsonString, options);
    }
    static equals(a, b) {
        return protobuf_1.proto3.util.equals(DeltaDiscoveryRequest, a, b);
    }
}
exports.DeltaDiscoveryRequest = DeltaDiscoveryRequest;
/**
 * [#next-free-field: 7]
 *
 * @generated from message envoy.api.v2.DeltaDiscoveryResponse
 */
class DeltaDiscoveryResponse extends protobuf_1.Message {
    /**
    ...
    static runtime = protobuf_1.proto3;
    static typeName = "envoy.api.v2.DeltaDiscoveryResponse";
    static fields = protobuf_1.proto3.util.newFieldList(() => [
    ...
    static fromBinary(bytes, options) {
        return new DeltaDiscoveryResponse().fromBinary(bytes, options);
    }
    static fromJson(jsonValue, options) {
        return new DeltaDiscoveryResponse().fromJson(jsonValue, options);
    }
    static fromJsonString(jsonString, options) {
        return new DeltaDiscoveryResponse().fromJsonString(jsonString, options);
    }
    static equals(a, b) {
        return protobuf_1.proto3.util.equals(DeltaDiscoveryResponse, a, b);
    }
}
exports.DeltaDiscoveryResponse = DeltaDiscoveryResponse;
/**
