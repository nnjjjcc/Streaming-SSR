...
class DurationRules extends protobuf_1.Message {
    ...
    static fields = protobuf_1.proto2.util.newFieldList(() => [
        { no: 1, name: "required", kind: "scalar", T: 8 /* ScalarType.BOOL */, opt: true },
        { no: 2, name: "const", kind: "message", T: duration_pb_1.Duration, opt: true },
        { no: 3, name: "lt", kind: "message", T: duration_pb_1.Duration, opt: true },
        { no: 4, name: "lte", kind: "message", T: duration_pb_1.Duration, opt: true },
        { no: 5, name: "gt", kind: "message", T: duration_pb_1.Duration, opt: true },
        { no: 6, name: "gte", kind: "message", T: duration_pb_1.Duration, opt: true },
        { no: 7, name: "in", kind: "message", T: duration_pb_1.Duration, repeated: true },
        { no: 8, name: "not_in", kind: "message", T: duration_pb_1.Duration, repeated: true },
    ]);
    static fromBinary(bytes, options) {
...
class TimestampRules extends protobuf_1.Message {
    ...
    static fields = protobuf_1.proto2.util.newFieldList(() => [
        { no: 1, name: "required", kind: "scalar", T: 8 /* ScalarType.BOOL */, opt: true },
        { no: 2, name: "const", kind: "message", T: timestamp_pb_1.Timestamp, opt: true },
        { no: 3, name: "lt", kind: "message", T: timestamp_pb_1.Timestamp, opt: true },
        { no: 4, name: "lte", kind: "message", T: timestamp_pb_1.Timestamp, opt: true },
        { no: 5, name: "gt", kind: "message", T: timestamp_pb_1.Timestamp, opt: true },
        { no: 6, name: "gte", kind: "message", T: timestamp_pb_1.Timestamp, opt: true },
        { no: 7, name: "lt_now", kind: "scalar", T: 8 /* ScalarType.BOOL */, opt: true },
        { no: 8, name: "gt_now", kind: "scalar", T: 8 /* ScalarType.BOOL */, opt: true },
        { no: 9, name: "within", kind: "message", T: duration_pb_1.Duration, opt: true },
    ]);
    static fromBinary(bytes, options) {
