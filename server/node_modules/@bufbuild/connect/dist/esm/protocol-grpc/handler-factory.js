...
import { validateUniversalHandlerOptions, uResponseMethodNotAllowed, uResponseOk, uResponseUnsupportedMediaType, assertByteStreamRequest, compressionNegotiate, contentTypeMatcher, createMethodSerializationLookup, createMethodUrl, pipe, transformCatch, transformCompressEnvelope, transformDecompressEnvelope, transformJoinEnvelopes, transformParseEnvelope, transformPrepend, transformSerializeEnvelope, transformSplitEnvelope, transformInvokeImplementation, } from "../protocol/index.js";
...
function createHandler(opt, spec) {
    ...
    return async function handle(req) {
        ...
        return Object.assign(Object.assign({}, uResponseOk), { body: outputIt, header: context.responseHeader, trailer: context.responseTrailer });
    };
}
