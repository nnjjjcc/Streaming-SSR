...
import { createAsyncIterable, createMethodSerializationLookup, createMethodUrl, pipe, pipeTo, transformCompressEnvelope, transformDecompressEnvelope, transformJoinEnvelopes, transformNormalizeMessage, transformParseEnvelope, transformSerializeEnvelope, transformSplitEnvelope, } from "../protocol/index.js";
    ...
    return {
        async unary(service, method, signal, timeoutMs, header, input) {
            ...
            return await runUnary({
                ...
                const { compression } = validateResponseWithCompression(opt.useBinaryFormat, opt.acceptCompression, uRes.status, uRes.header);
        ...
        async stream(service, method, signal, timeoutMs, header, input) {
            ...
            return runStreaming({
                ...
                const { compression, foundStatus } = validateResponseWithCompression(opt.useBinaryFormat, opt.acceptCompression, uRes.status, uRes.header);
