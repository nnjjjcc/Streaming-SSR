...
export function validateUniversalHandlerOptions(opt) {
    ...
    return Object.assign(Object.assign({ acceptCompression }, validateReadWriteMaxBytes(opt.readMaxBytes, opt.writeMaxBytes, opt.compressMinBytes)), { jsonOptions: opt.jsonOptions, binaryOptions: opt.binaryOptions, maxDeadlineDurationMs, shutdownSignal: opt.shutdownSignal, requireConnectProtocolHeader });
}
/**
