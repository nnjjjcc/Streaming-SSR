...
function parseTimeout(value) {
    ...
    if (results === null) {
        return new connect_error_js_1.ConnectError(`protocol error: invalid grpc timeout value: ${value}`, code_js_1.Code.InvalidArgument);
    }
    ...
    return (unitToMultiplicand[results[2]] *
        parseInt(results[1]));
}
