...
function setTrailerStatus(target, error) {
    if (error) {
        ...
        target.set(headers_js_1.headerGrpcStatus, exports.grpcStatusOk);
    }
    return target;
}
...
function findTrailerError(headerOrTrailer) {
    ...
    if (grpcStatus != null) {
        ...
        return new connect_error_js_1.ConnectError(`invalid grpc-status: ${grpcStatus}`, code_js_1.Code.Internal);
    }
    return undefined;
}
