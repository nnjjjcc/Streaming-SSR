...
function createConnectRouter(routerOptions) {
    ...
    return {
        ...
        service(service, implementation, options) {
            ...
            handlers.push(...(0, index_js_1.createUniversalServiceHandlers)((0, implementation_js_1.createServiceImplSpec)(service, implementation), protocols));
            return this;
        },
        rpc(service, method, implementation, options) {
            const { protocols } = whichProtocols(options, base);
            handlers.push((0, index_js_1.createUniversalMethodHandler)((0, implementation_js_1.createMethodImplSpec)(service, method, implementation), protocols));
            return this;
        },
    };
}
...
function whichProtocols(options, base) {
    ...
    const opt = base
        ? Object.assign(Object.assign({}, (0, index_js_1.validateUniversalHandlerOptions)(base.options)), options) : Object.assign(Object.assign({}, options), (0, index_js_1.validateUniversalHandlerOptions)(options !== null && options !== void 0 ? options : {}));
    const protocols = [];
