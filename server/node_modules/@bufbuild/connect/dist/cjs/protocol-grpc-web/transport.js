    ...
    return {
        async unary(service, method, signal, timeoutMs, header, message) {
            ...
            return await (0, index_js_1.runUnary)({
                ...
                const { trailer, message } = await (0, index_js_2.pipeTo)(uRes.body, (0, index_js_2.transformSplitEnvelope)(opt.readMaxBytes), (0, index_js_2.transformDecompressEnvelope)(compression !== null && compression !== void 0 ? compression : null, opt.readMaxBytes), (0, index_js_2.transformParseEnvelope)(serialization.getO(opt.useBinaryFormat), trailer_js_1.trailerFlag, (0, trailer_js_1.createTrailerSerialization)()), async (iterable) => {
                    var _a, e_1, _b, _c;
                    let message;
                    let trailer;
                    try {
                            ...
                            try {
                                ...
                                if (env.end) {
                                    if (trailer !== undefined) {
                                        throw new index_js_1.ConnectError("protocol error: received extra trailer", index_js_1.Code.InvalidArgument);
                                    }
                                    trailer = env.value;
                                }
                                else {
                ...
                if (trailer === undefined) {
                    throw new index_js_1.ConnectError("protocol error: missing trailer", index_js_1.Code.InvalidArgument);
                }
        ...
        async stream(service, method, signal, timeoutMs, header, input) {
            ...
            return (0, index_js_1.runStreaming)({
                ...
                const res = Object.assign(Object.assign({}, req), { header: uRes.header, trailer: new Headers(), message: (0, index_js_2.pipe)(uRes.body, (0, index_js_2.transformSplitEnvelope)(opt.readMaxBytes), (0, index_js_2.transformDecompressEnvelope)(compression !== null && compression !== void 0 ? compression : null, opt.readMaxBytes), (0, index_js_2.transformParseEnvelope)(serialization.getO(opt.useBinaryFormat), trailer_js_1.trailerFlag, (0, trailer_js_1.createTrailerSerialization)()), function (iterable) {
                        return __asyncGenerator(this, arguments, function* () {
                            ...
                            if (foundStatus) {
                                ...
                                if (r.done !== true) {
                                    throw new index_js_1.ConnectError("protocol error: extra data for trailers-only", index_js_1.Code.InvalidArgument);
                                }
                            ...
                            try {
                                for (var _d = true, iterable_2 = __asyncValues(iterable), iterable_2_1; iterable_2_1 = yield __await(iterable_2.next()), _a = iterable_2_1.done, !_a;) {
                                    ...
                                    try {
                                        ...
                                        if (trailerReceived) {
                                            throw new index_js_1.ConnectError("protocol error: received extra message after trailer", index_js_1.Code.InvalidArgument);
                                        }
