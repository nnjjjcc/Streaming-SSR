...
const index_js_1 = require("../protocol-grpc/index.js");
const index_js_2 = require("../protocol-grpc/index.js");
...
function validateResponse(useBinaryFormat, status, headers) {
    var _a;
    const code = (0, index_js_1.codeFromHttpStatus)(status);
    if (code != null) {
    ...
    if (parsedType.text) {
        throw new connect_error_js_1.ConnectError("grpc-web-text is not supported", code_js_1.Code.InvalidArgument);
    }
    const err = (0, index_js_2.findTrailerError)(headers);
    if (err) {
        throw err;
    }
