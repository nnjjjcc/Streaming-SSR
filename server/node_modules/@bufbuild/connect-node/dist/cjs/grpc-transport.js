...
exports.createGrpcTransport = void 0;
const protocol_grpc_1 = require("@bufbuild/connect/protocol-grpc");
...
function createGrpcTransport(options) {
    ...
    return (0, protocol_grpc_1.createTransport)(Object.assign(Object.assign({}, opt), { httpClient: client }));
}
