 ...
 */
export function universalRequestFromNodeRequest(nodeRequest, parsedJsonBody) {
    var _a, _b;
...
export async function universalResponseToNodeResponse(universalResponse, nodeResponse) {
    ...
    try {
        if (universalResponse.body instanceof Uint8Array) {
            ...
            try {
                for (var _d = true, _e = __asyncValues(universalResponse.body), _f; _f = await _e.next(), _a = _f.done, !_a;) {
                    _c = _f.value;
                    _d = false;
                    try {
                        const chunk = _c;
